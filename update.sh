...
curl -sL https://raw.githubusercontent.com/ddclient/ddclient/master/ddclient -o /usr/sbin/ddclient
...
curl -sL https://github.com/DNSCrypt/dnscrypt-proxy/releases/download/2.0.42/dnscrypt-proxy-linux_mips64-2.0.42.tar.gz -o dnscrypt.tar.gz
mkdir /opt/dnscrypt
